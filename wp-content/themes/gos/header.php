...
<!DOCTYPE html>
<!--[if lt IE 7]>      <html class="ie ie-no-support" <?php language_attributes(); ?> <?php body_class(); ?>> <![endif]-->
<!--[if IE 7]>         <html class="ie ie7" <?php language_attributes(); ?> <?php body_class(); ?>> <![endif]-->
<!--[if IE 8]>         <html class="ie ie8" <?php language_attributes(); ?> <?php body_class(); ?>> <![endif]-->
<!--[if IE 9]>         <html class="ie ie9" <?php language_attributes(); ?> <?php body_class(); ?>> <![endif]-->
<!--[if gt IE 9]><!--> <html <?php language_attributes(); ?> <?php body_class(); ?>> <!--<![endif]-->
  <head>
