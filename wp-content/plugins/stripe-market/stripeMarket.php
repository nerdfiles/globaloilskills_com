...
class stripeMarket{
	 ...
	 * @var      string
	 */
	protected $plugin_slug = "stripe-market";
	...
	public function enqueue_admin_scripts() {
		...
		$screen = get_current_screen();
		if ($screen->id == $this->plugin_screen_hook_suffix) {
      wp_enqueue_script($this->plugin_slug . "-admin-script", plugins_url("js/stripe-market-admin.js", __FILE__),
    ...
    $this->plugin_screen_hook_suffix = add_plugins_page(
      __("stripe-market - Administration", $this->plugin_slug),
      __("stripe-market", $this->plugin_slug),
      "read",
      $this->plugin_slug,
